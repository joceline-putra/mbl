<main class="guide-profile">
    ...
    <section class="banner position-relative">
      <img src="../assets/images/profile/guide-profile-banner.png" alt="Banner" class="w-100 img-fluid">
    ...
    <section class="profile-info px-24">
      <div class="image overflow-hidden radius-10">
        <img src="../assets/images/profile/profile.png" alt="profile" class="img-fluid w-100">
      </div>

      <h3>Jonsky Alexia</h3>
      <p>International tour guide in <span>india</span> <br> Travel and food vlogger</p>
      <div class="d-flex align-items-center gap-16">
        <a href="#" class="msg-btn flex-grow d-inline-block radius-12">Send Message</a>
        <a href="#" class="call-btn shrink-0 d-inline-block radius-12">Call Now</a>
      </div>
    </section>
    <!-- profile-info end -->
