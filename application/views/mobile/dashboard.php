<main class="home">
    ...
    <section class="info d-flex align-items-start justify-content-between pb-12">
      ...
      <ul class="d-flex align-items-center gap-16">
        <li>
          <a href="<?php echo base_url('index/notification');?>" class="d-flex align-items-center justify-content-center rounded-full position-relative">
            <img src="../assets/svg/bell-black.svg" alt="icon">
            <span class="dot"></span>
          </a>
        </li>
        <li>
          <a href="<?php echo base_url('index/message'); ?>" class="d-flex align-items-center justify-content-center rounded-full position-relative">
    ...
    <section class="guide py-12">
      ...
      <div class="title d-flex align-items-center justify-content-between">
        ...
        <a href="<?php echo base_url('index/tour_guide');?>" class="shrink-0 d-inline-block">See All</a>
      </div>
    ...
    <section class="budget pt-12">
      ...
      <div class="title d-flex align-items-center justify-content-between">
        ...
        <a href="<?php echo base_url('index/hotel');?>" class="shrink-0 d-inline-block">See All</a>
      </div>
